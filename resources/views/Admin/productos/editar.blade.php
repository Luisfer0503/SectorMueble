                    ...
                    <div id="acabados-container" class="space-y-4">
                        ...
                        @foreach($acabadosExistentes as $idx => $acab)
                            @php
                                ...
                                $descuentoVal = is_object($acab) ? ($acab->porcentaje_descuento ?? 0) : ($acab['porcentaje_descuento'] ?? 0);
                            ...
                            <div class="acabado-row p-4 bg-zinc-50/90 border border-zinc-200 rounded-2xl space-y-3">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-3 items-end">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="0" max="99" name="acabados_descuentos[]" value="{{ $descuentoVal }}" placeholder="0" class="w-full bg-white border border-zinc-200 rounded-lg text-xs px-2.5 py-2 focus:outline-none focus:ring-1 focus:ring-amber-700 font-semibold text-rose-700">
                                    </div>
