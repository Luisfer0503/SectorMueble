                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <a href="{{ route('checkout') }}" 
                           style="background-color: #88674B;" 
                           class="mt-3.5 inline-flex items-center justify-center space-x-2 w-full hover:bg-[#74563C] active:scale-[0.99] text-white text-xs font-bold uppercase tracking-wider py-3 px-4 rounded-xl transition-all shadow-md hover:shadow-lg border border-white/20">
