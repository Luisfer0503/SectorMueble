...
@section('titulo', 'Aviso de Privacidad | Sector Mueble')
...
<div class="bg-[#FAF8F5] py-10 sm:py-16 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center space-x-2 text-xs font-semibold text-zinc-500 mb-6">
            ...
            <span>/</span>
            <span class="text-zinc-800">Aviso de Privacidad</span>
        </nav>

        <!-- Contenedor Principal Completo a Pantalla Completa (100% Ancho) -->
        <main class="w-full space-y-6">
            
            <!-- Encabezado Principal del Aviso de Privacidad -->
            <div class="bg-white border border-zinc-200/90 rounded-3xl p-6 sm:p-10 shadow-lg relative overflow-hidden">
                ...
                <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed font-normal">
                    Política oficial de tratamiento y protección de datos personales expedida de conformidad con la Ley Federal de Protección de Datos Personales en Posesión de los Particulares para <strong class="text-zinc-900">CASA TAPICERÍA Y ATELIER S.A. de C.V. (SECTOR MUEBLE)</strong>.
                </p>
            </div>

            <!-- Despliegue de Secciones del Aviso de Privacidad -->
