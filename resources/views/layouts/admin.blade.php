    ...
    <aside id="mobileAdminSidebar" class="fixed top-0 left-0 bottom-0 z-50 w-72 bg-zinc-900 text-white flex flex-col justify-between border-r border-zinc-800 transform -translate-x-full transition-transform duration-300 ease-in-out md:hidden">
        <div>
            ...
            <nav class="mt-4 px-4 space-y-1 overflow-y-auto max-h-[calc(100vh-160px)]">
                <a href="{{ route('admin.dashboard') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.dashboard') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                ...
                <a href="{{ route('admin.productos') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.productos') || Route::is('admin.productos.*') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.cupones') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.cupones') || Route::is('admin.cupones.*') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.ruleta') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.ruleta') || Route::is('admin.ruleta.*') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.zapatos') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.zapatos') || Route::is('admin.zapatos.*') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('admin.pedidos') }}" onclick="cerrarSidebarMovil()" class="flex items-center px-4 py-3 text-sm font-medium rounded transition-colors {{ Route::is('admin.pedidos') || Route::is('admin.pedidos.*') ? 'bg-amber-800 text-white' : 'text-zinc-400 hover:bg-zinc-800 hover:text-white' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
