        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2.5 text-sm">
                        <li><a href="{{ route('politicas-envio') }}" class="hover:text-[#FAF3E0] transition-colors">Políticas de Envío</a></li>
                        <li><a href="{{ route('terminos') }}" class="hover:text-[#FAF3E0] transition-colors">Términos y Condiciones</a></li>
                        <li><a href="{{ route('privacidad') }}" class="hover:text-[#FAF3E0] transition-colors">Aviso de Privacidad</a></li>
                        <li class="pt-2">
